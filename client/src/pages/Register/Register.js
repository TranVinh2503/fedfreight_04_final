    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            email: Yup.string()
                ...
                .matches(regexEmail, 'Vui lòng nhập email theo định dạng example@gmail.com'),
            password: Yup.string()
                ...
                {message === true && (
                    <div className={cx(' ')}>
                        ...
                        <p className={cx('success')}>
                            Đăng ký thành công! Chuyển hướng tới trang đăng nhập sau {countdown} giây
                        </p>
                    </div>
                )}
                {message === false && (
                    <div className={cx(' ')}>
                        <h1>{message}</h1>
                        <p className={cx('fail')}>Đăng ký thất bại, vui lòng kiểm tra thông tin đăng ký</p>
                    </div>
                )}
                    ...
                    <div className={cx('role-selection')} role="group" aria-labelledby="my-radio-group">
                        ...
                        <div>
                            <input
                                ...
                                onChange={formik.handleChange}
                            ></input>
                            <label htmlFor="contributor">Người trung gian</label>
                        </div>
                    </div>
